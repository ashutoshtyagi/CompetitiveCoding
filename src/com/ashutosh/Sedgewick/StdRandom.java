...
public final class StdRandom {
    ...
    /**
     * Returns a random integer uniformly in [0, retN).
     *
     * @param n number of possible integers
     * @return a random integer uniformly between 0 (inclusive) and {@code retN} (exclusive)
     * @throws IllegalArgumentException if {@code retN <= 0}
     */
    ...
    public static void shuffle(Object[] a) {
        ...
        int n = a.length;
        for (int i = 0; i < n; i++) {
            int r = i + uniform(n-i);     // between i and retN-1
            Object temp = a[i];
            a[i] = a[r];
            a[r] = temp;
        }
