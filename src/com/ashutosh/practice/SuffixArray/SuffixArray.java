...
/**
 * Created by ashutosh on 6/11/16.
 */
public class SuffixArray {
    ...
    public static void main(String[] args) {
        ...
        int[] suffixArr = suffixArray.getSuffixIndexes();
        System.out.println(Arrays.toString(suffixArr));

        String longestRepeatedSubstring = suffixArray.getLongestRepeatedSubstring();
        System.out.println("longestRepeatedSubstring = " + longestRepeatedSubstring);

        String longestNonOverlappingRepeatedSubstring = suffixArray.getLongestNonOverlappingRepeatedSubstring();
        System.out.println("longestNonOverlappingRepeatedSubstring = " + longestNonOverlappingRepeatedSubstring);

        String getCommonPrefixAtGivenSuffixIndex = suffixArray.getCommonPrefixAtGivenSuffixIndex(2);
        System.out.println("getCommonPrefixAtGivenSuffixIndex = " + getCommonPrefixAtGivenSuffixIndex);

        int getCommonPrefixLenghtAtGivenSuffixIndex = suffixArray.getCommonPrefixLengthAtGivenSuffixIndex(2);
        System.out.println("getCommonPrefixLenghtAtGivenSuffixIndex = " + getCommonPrefixLenghtAtGivenSuffixIndex);

        int getLengthOfSuffixAtGivenSuffixIndex = suffixArray.getLengthOfSuffixAtGivenSuffixIndex(2);
        System.out.println("getLengthOfSuffixAtGivenSuffixIndex = " + getLengthOfSuffixAtGivenSuffixIndex);
    }
